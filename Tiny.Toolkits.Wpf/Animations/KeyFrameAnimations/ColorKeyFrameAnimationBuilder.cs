...
{
    /// <summary>																											      
    /// a class of <see cref="ColorKeyFrameAnimationBuilder{T}"/>																		 
    /// </summary>																											      
    /// <typeparam name="T">dependencyObject type</typeparam>																			 
    public class ColorKeyFrameAnimationBuilder<T> : AnimationBuilderBase<ColorKeyFrameAnimationBuilder<T>, T> where T : DependencyObject
    {
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private bool? boolValue;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] private readonly List<ColorKeyFrame> frames = new();
        ...
        /// <returns></returns>                                                                                                                             
        public ColorKeyFrameAnimationBuilder<T> Add(Color value, TimeSpan beginTime)
        {
            frames.Add(new LinearColorKeyFrame(value, beginTime));
        ...
        /// <returns></returns>                                                                                                                             
        public ColorKeyFrameAnimationBuilder<T> IsCumulative(bool boolValue)
        {
        ...
        public IAnimationPlayer BuildAnimation()
        {
            ...
            foreach (ColorKeyFrame item in frames)
            {
